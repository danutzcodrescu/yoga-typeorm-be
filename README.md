...
CI and CD is done using [CircleCI](https://circleci.com/) by running tests and deployment to a private docker repo hosted on AWS ECR. The deployment to ECR is done using a personal deployment [docker image](https://hub.docker.com/r/danutzcodrescu/circle-ci-docker/)
